    ...
    <Layout>
      <h1>
        ...
        <a href="https://github.com/saddiqs1/nextjs-ts-steam-auth-iron-session">
          nextjs-ts-steam-auth-iron-session
        </a>
        <br />
      ...
      <p>
        This example creates an authentication system using <b>steam login</b>,
        which uses a <b>signed and encrypted cookie to store session data</b>.
      </p>
      ...
      <ol>
        <li>Click login to login via Steam.</li>
        <li>
          Click home and click profile again, notice how your session is being
          used through a token stored in a cookie.
        </li>
        <li>
          Click logout and try to go to profile again (
          <a href={"/profile-sg"}>Static Generation</a> |{" "}
          <a href={"/profile-ssr"}>Server-side Rendering</a>). You&apos;ll get
